...
class ViewController: UIViewController, UICollisionBehaviorDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @objc func handleLongPressGesture(_ gesture: UILongPressGestureRecognizer) {
        ...
        case .began:
            guard let targeIndexPath = collectionView.indexPathForItem(
